...
const checkDogs = function (dogsJulia, dogsKate) {
  const dogsJuliaShallow = dogsJulia.slice(1, 4);
  const julieKateDogs = dogsJuliaShallow.concat(dogsKate);
  console.log(julieKateDogs);
  //output:
  //   [
  //   5,  2, 12, 4,
  //   1, 15,  8, 3
  ...
  julieKateDogs.forEach(function (dog, i) {
    if (dog >= 3) {
...
// Dog number 3 is an adult , and 12 years old
// Dog number 4 is an adult , and 4 years old
// Dog number 5 is still a puppy 🐶
// Dog number 6 is an adult , and 15 years old
// Dog number 7 is an adult , and 8 years old
// Dog number 8 is an adult , and 3 years old
...
const calcAverageHumanAge = function (dogAges) {
  var humanAge = dogAges.map(function (age) {
    if (age <= 2) {
  ...
  const averageAge = adultDogAge.reduce(function (acc, age) {
    return (acc + age) / adultDogAge.length;
  }, 0);
...
// const calcAverageHumanAge = dogAge1.map(function (age, i, arr) {
//   if (age <= 2) {
//     return (humanAge = 2 * age);
//   } else age > 2;
//   return (humanAge = 16 + age * 4);
...
// const dogs = dogAge2.filter(function (age) {
//   return age > 18;
// });

// console.log(dogs);

// const average = dogAge1.reduce(function (acc, age, arr) {
